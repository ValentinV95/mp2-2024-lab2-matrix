...
TEST(TDynamicMatrix, assign_matrix_to_itself_is_correct)
{
	TDynamicMatrix<int> m(5);
	for (int i = 0; i < 5; ++i)
		for (int j = 0; j < 5; ++j)
...
TEST(TDynamicMatrix, assign_matrices_of_equal_size_is_correct)
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> w(5);
	for (int i = 0; i < 5; ++i) {
...
TEST(TDynamicMatrix, assign_operator_is_correct)
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> w(6);
	for (int i = 0; i < 5; ++i) {
...
TEST(TDynamicMatrix, assign_operator_of_equal_sized_vectors_is_correct)
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> w(5);
	for (int i = 0; i < 5; ++i) {
...
TEST(TDynamicMatrix, matrices_with_equal_size_is_correct)
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> w(5);
	TDynamicMatrix<int> res(5);
...
TEST(TDynamicMatrix, subtract_matrices_with_equal_size_is_correct)
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> w(5);
	TDynamicMatrix<int> res(5);
...
TEST(TDynamicMatrix, multiply_scalar_by_matrix_is_correct) // my test
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> res(5);
	for (int i = 0; i < 5; ++i) {
...
TEST(TDynamicMatrix, multiply_vector_by_matrix_is_correct) // my test
{
	TDynamicMatrix<int> m(5);
	TDynamicVector<int> v(5);
	TDynamicVector<int> res(5);
...
TEST(TDynamicMatrix, multiply_matrixex_is_correct) // my test
{
	TDynamicMatrix<int> m(5);
	TDynamicMatrix<int> w(5);
	TDynamicMatrix<int> res(5);
